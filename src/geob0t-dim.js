module.exports = function Theme (Ui) {
    ...
    const colors = {
        ...
        strings: "#288b7f",             // strings
        markupDiff: "#e0c285",
        diff: "#569cd6",
        numbers: "#e5c07b",             // JS numbers, md bold, java imports, etc.
        constants: "#d19a66",           // JS constants, HTML attributes, etc.
        functions: "#1da3bc",           // JS functions/operators
        functionCall: "#1da3bc",        // function execution
        variables: "#b51d45",           // JS variables, HTML Tags
        bitwiseOperators: "#3cb973",    // globals, bitwise operators, regex (i.e. the forward slashes in regex)
        keywords: "#b267e6",            // reserved keywords (const, return, public, private, etc.)
        embedded: "#be4f44",            // ?
        info: "#6796e6",
        warning: "#bb641d",
        error: "#bbab1d",
        debug: "#e4a1e4",
        broken_background: "#70183e",
        broken_foreground: "#fff",
        deprecated_background: "#d17020",
