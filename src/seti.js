...
module.exports = function Theme (Ui) {
    const colors = {
        background: "#0e1112",          // dark background
        foreground:  "#d4d7d6",         // "#bbbbbbff" // text
        text: "#d4d7d6",
        brightText: "#ffffff",          // bold and italic texts
        headings: "#e1793c",            // md headings
        bold: "#cbca4d",                // md ** and _ chars
        quotes: "#9bc4d6",              // md block quotes
        comments: "#4d5a5e",            // comments and punctuation
        params: "#4d5a5e",              // "#b9c0ca" // function params / commas
        strings: "#549ab8",             // "#98c378"
        markupDiff: "#cbca4d",
        diff: "#ca4047",
        numbers: "#805f9c",             // "#c49060" // JS numbers, md bold, java imports, etc.
        constants: "#8ebf51",           // "#D18C4E", #D2945D // JS constants, HTML attributes, etc.
        functions: "#cbca4d",           // JS functions/operators
        functionCall: "#cbca4d",        // function execution
        variables: "#8ebf51",           // JS variables, object properties, HTML Tags
        operators: "#ca4047",
        bitwiseOperators: "#ca4047",    // globals, bitwise operators, regex (i.e. the forward slashes in regex)
        keywords: "#d4d7d6",            // "#C178DD" "#C679DD" // reserved keywords (const, return, public, private, etc.)
        embedded: "#cbca4d",            // ?
        info: "#549ab8",
        warning: "#e1793c",
        error: "#f44747",               // "#ff0000"
        debug: "#b267e6",
        broken_background: "#ca4047",
        broken_foreground: "#fff",
        deprecated_background: "#e1793c",
        deprecated_foreground: "#fff",
        notImplemented_background: "#4d5a5e",
        notImplemented_foreground: "#fff"
    }

    const ui = new Ui({
        editorBackground: "#0e1112ff",
        editorRuler: "#242c2f",
        editorHighlightBackground: "#242c2f",
        editorLineHighlight: "#242c2f",
        nonNativeHover: "#4d5a5e",
    }).colors;
